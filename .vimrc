...
" close all buffers but active one
noremap <leader>ca :w\|%bd\|e#
...
" WILDIGNORE
set wildignore=*.swp,*.bak,*.pyc,*.class,*.jar,*.gif,*.png,*.jpg,node_modules,.git,ios,*.ttf,tmp,*.beam,*/_build,*/deps
...
" MY NOTE: this hides the file path.  needs adjustment
...
" ELIXIR
" Use ale to lint and format on the fly
let g:ale_fixers = { 'elixir': ['mix_format'] }

" COMMAND-T
let gCommandTFileScanner = "git"
